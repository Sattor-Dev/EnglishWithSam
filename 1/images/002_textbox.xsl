...
<xsl:template match="params">
	...
	<div>
		...
		<xsl:attribute name="style">position: absolute; top: 0px; left: 0px; width: <xsl:value-of select="$width"/>px; height: <xsl:value-of select="$height"/>px;</xsl:attribute>
		<div>
			<xsl:attribute name="id"><xsl:value-of select="$objectID"/>_w3c_0</xsl:attribute>	
			<xsl:attribute name="style">position: absolute; top: <xsl:value-of select="$shape.0.top"/>px; left: <xsl:value-of select="$shape.0.left"/>px; width: <xsl:value-of select="$shape.0.width"/>px; height: <xsl:value-of select="$shape.0.height"/>px; 
				<xsl:if test="shadow='yes'">-moz-box-shadow: <xsl:value-of select="$shadow.string.w3c"/>; -webkit-box-shadow: <xsl:value-of select="$shadow.string.w3c"/>; box-shadow: <xsl:value-of select="$shadow.string.w3c"/>;</xsl:if>
				-moz-border-radius: <xsl:value-of select="$shape.0.radius"/>px; -webkit-border-radius: <xsl:value-of select="$shape.0.radius"/>px; -khtml-border-radius: <xsl:value-of select="$shape.0.radius"/>px; border-radius: <xsl:value-of select="$shape.0.radius"/>px; border: solid 0px <xsl:value-of select="$color.light"/>;
				background-color: <xsl:value-of select="$color.light"/>; background: -webkit-gradient(linear, 0 0, 100% 100%, from(<xsl:value-of select="$color.lighter"/>), to(<xsl:value-of select="$color.darker"/>)); background: -moz-linear-gradient( -30deg, <xsl:value-of select="$color.lighter"/>, <xsl:value-of select="$color.darker"/> );
			</xsl:attribute>
			<br/>
		</div>
		<div>
			<xsl:attribute name="id"><xsl:value-of select="$objectID"/>_w3c_1</xsl:attribute>	
			<xsl:attribute name="style">position: absolute; top: <xsl:value-of select="$shape.1.top"/>px; left: <xsl:value-of select="$shape.1.left"/>px; width: <xsl:value-of select="$shape.1.width"/>px; height: <xsl:value-of select="$shape.1.height"/>px; 
				-moz-border-radius: <xsl:value-of select="$shape.1.radius"/>px; -webkit-border-radius: <xsl:value-of select="$shape.1.radius"/>px; -khtml-border-radius: <xsl:value-of select="$shape.1.radius"/>px; border-radius: <xsl:value-of select="$shape.1.radius"/>px; border: solid 0px <xsl:value-of select="$color.fill"/>;
				background-color: <xsl:value-of select="$color.fill"/>; background: -webkit-gradient(linear, 0 0, 100% 100%, from(<xsl:value-of select="$color.fill"/>), to(<xsl:value-of select="$color.dark"/>)); background: -moz-linear-gradient( -30deg, <xsl:value-of select="$color.fill"/>, <xsl:value-of select="$color.dark"/> );
			</xsl:attribute>
			<br/>
		</div>
		<div>
			<xsl:attribute name="id"><xsl:value-of select="$objectID"/>_w3c_2</xsl:attribute>	
			<xsl:attribute name="style">position: absolute; top: <xsl:value-of select="$shape.2.top"/>px; left: <xsl:value-of select="$shape.2.left"/>px; width: <xsl:value-of select="$shape.2.width"/>px; height: <xsl:value-of select="$shape.2.height"/>px; 
				-moz-border-radius: <xsl:value-of select="$shape.2.radius"/>px; -webkit-border-radius: <xsl:value-of select="$shape.2.radius"/>px; -khtml-border-radius: <xsl:value-of select="$shape.2.radius"/>px; border-radius: <xsl:value-of select="$shape.2.radius"/>px; border: solid 0px <xsl:value-of select="$color.dark"/>;
				background-color: <xsl:value-of select="$color.fill"/>; 
			</xsl:attribute>
			<br/>
		</div>
		<div>
			<xsl:attribute name="id"><xsl:value-of select="$objectID"/>_w3c_3</xsl:attribute>	
			<xsl:attribute name="style">position: absolute; top: <xsl:value-of select="$shape.3.top"/>px; left: <xsl:value-of select="$shape.3.left"/>px; width: <xsl:value-of select="$shape.3.width"/>px; height: <xsl:value-of select="$shape.3.height"/>px; 
				-moz-border-radius: <xsl:value-of select="$shape.3.radius"/>px; -webkit-border-radius: <xsl:value-of select="$shape.3.radius"/>px; -khtml-border-radius: <xsl:value-of select="$shape.3.radius"/>px; border-radius: <xsl:value-of select="$shape.3.radius"/>px; border: solid 0px <xsl:value-of select="$color.dark"/>;
				background-color: <xsl:value-of select="$color.darker"/>; background: -webkit-gradient(linear, 0 0, 100% 100%, from(<xsl:value-of select="$color.darker"/>), to(<xsl:value-of select="$color.lighter"/>)); background: -moz-linear-gradient( -30deg, <xsl:value-of select="$color.darker"/>, <xsl:value-of select="$color.lighter"/> );
			</xsl:attribute>
			<br/>
		</div>
		<div>
			<xsl:attribute name="id"><xsl:value-of select="$objectID"/>_w3c_4</xsl:attribute>	
			<xsl:attribute name="style">position: absolute; top: <xsl:value-of select="$shape.4.top"/>px; left: <xsl:value-of select="$shape.4.left"/>px; width: <xsl:value-of select="$shape.4.width"/>px; height: <xsl:value-of select="$shape.4.height"/>px; 
				-moz-border-radius: <xsl:value-of select="$shape.4.radius"/>px; -webkit-border-radius: <xsl:value-of select="$shape.4.radius"/>px; -khtml-border-radius: <xsl:value-of select="$shape.4.radius"/>px; border-radius: <xsl:value-of select="$shape.4.radius"/>px; border: solid 0px <xsl:value-of select="$color.bg"/>;
				background-color: <xsl:value-of select="$color.bg"/>;
			</xsl:attribute>
			<br/>
		</div>
	</div>
	...
	<xsl:if test="onclick_hide='yes'">
		<div>
			...
			<xsl:attribute name="onclick">CallMethod("002_textbox", "Close", { pid: '<xsl:value-of select="$objectID"/>' }); return false;</xsl:attribute>
			<xsl:attribute name="style">cursor: pointer; position: absolute; top: <xsl:value-of select="$shape.0.top"/>px; left: <xsl:value-of select="$shape.0.left"/>px; width: <xsl:value-of select="$shape.0.width"/>px; height: <xsl:value-of select="$shape.0.height"/>px; overflow: hidden; font-size: <xsl:choose><xsl:when test="number($shape.0.height) &gt; number($shape.0.width)"><xsl:value-of select="$shape.0.height"/></xsl:when><xsl:otherwise><xsl:value-of select="$shape.0.width"/></xsl:otherwise></xsl:choose>px;</xsl:attribute>
			&#160;
		</div>
	</xsl:if>
