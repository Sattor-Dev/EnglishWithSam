...
function SCORM_Obtain(oWindow)
{
	...
	if (g_bUseScorm2004)
	{
		...
		if (oWindow.parent != null && oWindow.parent != oWindow)
		{
			...
			if(g_oScormApi==null && oWindow.parent.opener!=null) g_oScormApi = SCORM_ScanFor2004(oWindow.parent.opener);
		}
	...
	if (bFound == false)
	{
		if (g_bUseScorm12)
		{
			...
			if (oWindow.parent != null && oWindow.parent != oWindow)
			{
				...
				if(g_oScormApi==null && oWindow.parent.opener!=null) g_oScormApi = SCORM_ScanFor12(oWindow.parent.opener);
			}
